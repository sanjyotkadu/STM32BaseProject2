...
clean-Core-2f-Src-2f-Middleware:
	-$(RM) ./Core/Src/Middleware/DCMotCntrMod.cyclo ./Core/Src/Middleware/DCMotCntrMod.d ./Core/Src/Middleware/DCMotCntrMod.o ./Core/Src/Middleware/DCMotCntrMod.su ./Core/Src/Middleware/Input_Select.cyclo ./Core/Src/Middleware/Input_Select.d ./Core/Src/Middleware/Input_Select.o ./Core/Src/Middleware/Input_Select.su ./Core/Src/Middleware/JoyMod.cyclo ./Core/Src/Middleware/JoyMod.d ./Core/Src/Middleware/JoyMod.o ./Core/Src/Middleware/JoyMod.su ./Core/Src/Middleware/RCMod.cyclo ./Core/Src/Middleware/RCMod.d ./Core/Src/Middleware/RCMod.o ./Core/Src/Middleware/RCMod.su
